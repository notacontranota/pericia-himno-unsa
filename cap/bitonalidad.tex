...
\relative {
  \key f \major
  \hide Stem
  f'2\startGroup g a bes\stopGroup \bar "||"
  f'\startGroup e4 ( c2\stopGroup ) \bar "||"
  d4 ( bes2\startGroup ) c4 ( a2 ) g f\stopGroup ~\bar "||"
  f2\startGroup bes\stopGroup c\startGroup ( f4 ) d2 e f\stopGroup \bar "|."
}
\end{ly}
